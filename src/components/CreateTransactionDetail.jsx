...
const CreateTransactionDetail = () => {
	...
	return (
		<div className="inline-flex h-auto w-96 flex-col items-center justify-start bg-white">
			<div className="border-black/opacity-40 inline-flex items-center justify-center self-stretch border-b px-4 py-6">
				...
				<div className="shrink grow basis-0 text-center text-2xl font-bold text-black">Detail</div>
				<div className="flex w-8 items-center justify-center py-2 opacity-0" />
			</div>
