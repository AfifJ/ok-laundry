const AccountEdit = () => {
	return (
		<div class="inline-flex   w-96 flex-col items-start justify-start gap-8 bg-white">
			<div class="border-black/opacity-40 inline-flex items-center justify-center self-stretch border-b px-4 py-6">
				<div class="flex   w-8 items-center justify-center py-2"></div>
			...
			<div class="flex   flex-col items-center justify-start gap-12 self-stretch px-8">
