	...
	return (
		<div className="inline-flex w-96 flex-col items-center justify-start gap-8 bg-white">
			<div className="border-black/opacity-40 inline-flex items-center justify-center self-stretch border-b px-4 py-6">
				...
				<div className="flex h-8 w-8 items-center justify-center py-2 opacity-0"></div>
			</div>
					...
					{isEditing ? (
						<>
							...
							<button
								...
								className="inline-flex h-12 items-center justify-center gap-2.5 self-stretch rounded-2xl bg-green-500 px-12 py-3"
							>
